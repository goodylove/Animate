...
function LongVolitality() {
  ...
  return (
      <div className=' flex  items-center  justify-around  py-10 '>
           ...
           <motion.div className="relative mt-30  flex items-end justify-start ">
              <motion.img
                animate={{
                  y: "-20%",
                }}
              ...
              <motion.img
                ...
                me="w-[250px] absolute "
        />
              <div className='bg-[#FF630B]  h-[400px] w-[400px]  absolute z-10  bottom-14 rounded-full blur-[150px]'></div>
