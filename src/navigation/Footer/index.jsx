            ...
            <div className="">
              ...
              <div className="sm:flex flex-col hidden mt-10">
                ...
                <div className="flex items-center space-x-12 mt-6">
                  <img className="w-[34px]"   src="/assets/icons/twitter.png" alt="twitter" />
                  <img className="w-[34px]"   src="/assets/icons/medium.png" alt="medium" />{" "}
                  <img className="w-[34px]"    src="/assets/icons/telegram.png" alt="telegram" />{" "}
                  <img className="w-[34px]"   src="/assets/icons/discord.png" alt="discord" />
                </div>
              </div>
            </div>
            <div className="">
